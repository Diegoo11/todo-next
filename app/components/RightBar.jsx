    ...
    >
      ...
      <form className="h-full flex flex-col justify-start">
        <div className="mb-4">
          ...
          <input type="text" id="nombre" name="nombre" className="w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500" required />
        </div>
        <div className="mb-4">
          <label for="apellido" className="block mb-2 text-sm text-gray-600">
            Description
          </label>
          <textarea rows={4} className="resize-none w-full px-4 py-2 rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500" type="text" id="apellido" name="apellido" required />
        </div>
        <div className="mb-4">
